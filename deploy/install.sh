...
# Sub2API 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/SSYC-LJS/sub2api/main/deploy/install.sh | bash
#
...
Documentation=https://github.com/SSYC-LJS/sub2api
