export default {
  ...
  modelMarket: {
    title: 'Model Market',
    description: 'Shows available models by accessible group. Each card highlights the group name and current multiplier; lower multipliers are recommended more strongly.',
