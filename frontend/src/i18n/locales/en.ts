export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: 'How much RMB balance the user receives for each ￥1 paid',
        balanceRechargePreview: 'Preview: ￥1 = ￥{usd}',
        ...
        field_paymentCurrencyHint: 'Default is CNY. Stripe and Airwallex can choose another listed non-USD currency supported by the account; WeChat Pay, Alipay, and EasyPay remain CNY.',
  ...
  payment: {
    ...
    rechargeRatePreview: 'Current rate: ￥1 = ￥{usd}',
