export default {
  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: '用户每支付 1 元可获得多少人民币余额',
        balanceRechargePreview: '预览：1 元 = ￥{usd}',
        ...
        field_paymentCurrencyHint: '默认 CNY。Stripe 和 Airwallex 可按账户支持从下拉项选择账户支持的非美元币种；微信、支付宝、易支付仍按 CNY。',
  ...
  payment: {
    ...
    rechargeRatePreview: '当前倍率：1 元 = ￥{usd}',
    refundReason: '退款原因',
