...
import (
	...
	dbaccount "github.com/SSYC-LJS/sub2api/ent/account"
	dbapikey "github.com/SSYC-LJS/sub2api/ent/apikey"
	dbgroup "github.com/SSYC-LJS/sub2api/ent/group"
	"github.com/SSYC-LJS/sub2api/ent/schema/mixins"
	dbuser "github.com/SSYC-LJS/sub2api/ent/user"
	dbusersub "github.com/SSYC-LJS/sub2api/ent/usersubscription"
...
const usageLogSelectColumns = "id, user_id, api_key_id, account_id, request_id, model, requested_model, upstream_model, group_id, subscription_id, payer_user_id, parent_account_id, input_tokens, output_tokens, cache_creation_tokens, cache_read_tokens, cache_creation_5m_tokens, cache_creation_1h_tokens, image_output_tokens, image_output_cost, input_cost, output_cost, cache_creation_cost, cache_read_cost, total_cost, actual_cost, parent_quota_used, rate_multiplier, account_rate_multiplier, billing_type, request_type, stream, openai_ws_mode, duration_ms, first_token_ms, user_agent, ip_address, image_count, image_size, image_input_size, image_output_size, image_size_source, image_size_breakdown, video_count, video_resolution, video_duration_seconds, service_tier, reasoning_effort, inbound_endpoint, upstream_endpoint, cache_ttl_overridden, channel_id, model_mapping_chain, billing_tier, billing_mode, account_stats_cost, created_at"
...
func (r *usageLogRepository) ListByParentAccount(ctx context.Context, parentUserID int64, childUserID int64, params pagination.PaginationParams) ([]service.UsageLog, *pagination.PaginationResult, error) {
	where := "WHERE parent_account_id = $1"
...
// GetUserTokenRanking returns user token ranking aggregated within the time range.
func (r *usageLogRepository) GetUserTokenRanking(ctx context.Context, startTime, endTime time.Time, limit int) (result *UserSpendingRankingResponse, err error) {
	if limit <= 0 {
		limit = 10
	}
...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	...
	log := &service.UsageLog{
		...
		TotalCost:             totalCost,
		ActualCost:            actualCost,
		ParentQuotaUsed:       parentQuotaUsed,
	...
	if parentAccountID.Valid {
		value := parentAccountID.Int64
		log.ParentAccountID = &value
	}
	if durationMs.Valid {
