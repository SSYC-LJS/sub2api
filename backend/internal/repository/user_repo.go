...
import (
	...
	"github.com/SSYC-LJS/sub2api/ent/apikey"
	"github.com/SSYC-LJS/sub2api/ent/authidentity"
	"github.com/SSYC-LJS/sub2api/ent/authidentitychannel"
	dbgroup "github.com/SSYC-LJS/sub2api/ent/group"
	"github.com/SSYC-LJS/sub2api/ent/identityadoptiondecision"
	"github.com/SSYC-LJS/sub2api/ent/predicate"
	"github.com/SSYC-LJS/sub2api/ent/schema/mixins"
	dbuser "github.com/SSYC-LJS/sub2api/ent/user"
	"github.com/SSYC-LJS/sub2api/ent/userallowedgroup"
	"github.com/SSYC-LJS/sub2api/ent/usersubscription"
...
func applyUserEntityToService(dst *service.User, src *dbent.User) {
	...
	dst.IsParentAccount = src.IsParentAccount
