...
import (
	...
	adminhandler "github.com/SSYC-LJS/sub2api/internal/handler/admin"
...
func (r *stubUsageLogRepo) GetUserTokenRanking(ctx context.Context, startTime, endTime time.Time, limit int) (*usagestats.UserSpendingRankingResponse, error) {
	return nil, errors.New("not implemented")
}
