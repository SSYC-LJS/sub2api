...
// compositeBillableModel keeps composite aliases on an explicitly configured
// channel price, while avoiding family-prefix matches when no alias price exists.
