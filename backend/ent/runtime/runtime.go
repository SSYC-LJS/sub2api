...
func init() {
	...
	groupDescRecommendationLabel := groupFields[3].Descriptor()
	...
	groupDescRecommendationStars := groupFields[4].Descriptor()
	...
	// usagelogDescParentQuotaUsed is the schema descriptor for parent_quota_used field.
	usagelogDescParentQuotaUsed := usagelogFields[27].Descriptor()
	// usagelog.DefaultParentQuotaUsed holds the default value on creation for the parent_quota_used field.
	usagelog.DefaultParentQuotaUsed = usagelogDescParentQuotaUsed.Default.(float64)
	...
	userDescIsParentAccount := userFields[21].Descriptor()
